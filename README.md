...
### Figure 4: Cohort Quality on TGP
```
...
*Figure6A. Average CCPM group counts for cohorts generated by GenoSiS plotted as a heatmap. Group labels for the query samples are listed on the left axis, while the labels of sample which appear in their GenoSiS cohort appear on the bottom axis.*
</Figure>

#### Figure 6B: CCPM FST

```
python plotting/ccpm_prob.py
```
<Figure>

![ccpm_prob](pub_figures/ccpm_prob.png)
*Figure6B. CCPM ancestry prediction by population.*
</Figure>
...
#### Former..Figure 6B: CCPM FST

```
python plotting/plot_ccpm_fst.py \    
...
*Figure6B. CCPM FST by population.*
</Figure>