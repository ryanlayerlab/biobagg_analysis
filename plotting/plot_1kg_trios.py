...
def get_args():
    ...
    parser.add_argument('--hits', type=str, help='PED file', required=True)
    parser.add_argument('--dist', type=str, help='ancestry file', required=True)
...
def plot_1KG_trios(hits_dict, dist_dict, label_dict, pop, color, subpopulations, samples):
    ...
    plt.savefig('1kg_trio_plots/1KG_trios_' + pop + '_100of100.png')
